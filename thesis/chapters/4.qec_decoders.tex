...
This continuous back-and-forth exchange iteratively refines the global distribution of errors. This cycle continues until the variable nodes' probabilities converge to a clear, definitive error pattern that perfectly satisfies the observed syndrome. 
