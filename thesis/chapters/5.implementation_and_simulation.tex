...
Figure \ref{fig:threshold_theorem_plot} demonstrates this effect perfectly. 
\begin{figure}[hbt!]
    \centering
    \includegraphics[width=0.8\linewidth]{figures/s7_threshold_theorem.png}
    ...
    \label{fig:threshold_theorem_plot}
\end{figure}
