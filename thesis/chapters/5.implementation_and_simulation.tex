...
\begin{figure}[hbt!]
    \centering
    \includegraphics[width=0.6\linewidth]{figures/chapter_5/stim_rep_comparison_plot.png}
...
\begin{figure}[hbt!]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/chapter_5/stim_rep_circuit_noise_plot.png}
...
\begin{figure}[hbt!]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/chapter_5/stim_rep_circuit_distance_plot.png}
