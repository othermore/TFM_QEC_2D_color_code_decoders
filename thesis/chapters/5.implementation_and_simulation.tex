...
\begin{lstlisting}[caption={Generation of a repetition code circuit using Stim.},label={lst:stim_rep_code_noise}]
...
At this point, we can also study the effect of distance increases in the code. 
