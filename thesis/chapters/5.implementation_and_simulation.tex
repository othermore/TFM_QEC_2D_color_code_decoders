...
\includesnippet[caption={Simulation 9: Implementing a custom \texttt{cirq.NoiseModel} that applies the extracted error rates. The scale factor acts as a mathematical clamp to prevent probabilities from exceeding 1.0.}, label={lst:s9_model}]{S9_SNIPPET_MODEL}{../src/chapter_5/s9_qiskit_noise_model.py}
