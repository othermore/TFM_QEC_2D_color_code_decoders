...
\begin{notebox}{Pendiente}
Revisar estas gráficas, pensar como tienen que ser y arreglarlas
\end{notebox}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        \begin{tikzpicture}[scale=0.55]
            ...
            \begin{scope}
                ...
                % Red String 1 (Diagonal Up-Right)
                ...
                % Red String 2 (Diagonal Down-Right)
                \foreach \k in {-4, -3, -2, -1, 0, 1, 2, 3} {
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        ...
        \begin{tikzpicture}[scale=0.55]
            ...
            \node[below, red, font=\scriptsize] at (0, -3.1) {Red Boundary};
            \node[left, green!60!black, font=\scriptsize, align=right] at (-2.4, 0.8) {Green\\Boundary};
            \node[right, blue, font=\scriptsize, align=left] at (2.4, 0.8) {Blue\\Boundary};
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        \begin{tikzpicture}[scale=0.55]
            ...
            \node[above, font=\bfseries, blue, fill=white, inner sep=1.5pt] at (2.4, 0.5) {$X_{L1}, Z_{L2}$};
            \node[below right, font=\bfseries, green!60!black, fill=white, inner sep=1.5pt] at (0.5, 2.8) {$Z_{L1}, X_{L2}$};
            \node[above , font=\bfseries, red, fill=white, inner sep=1.5pt] at (2.5, 2.9) {$X_{L3}, Z_{L4}$};
            \node[below left, font=\bfseries, red!60!black, fill=white, inner sep=1.5pt] at (2.5, -2.5) {$Z_{L3}, X_{L4}$};
        \end{tikzpicture}
        \caption{}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.48\textwidth}
        ...
        \begin{tikzpicture}[scale=0.55]
            ...
            \node[above, font=\bfseries, green!60!black, fill=white, inner sep=1.5pt] at (0.4, 3.8) {$Z_L$};
            \node[above, font=\bfseries, blue, fill=white, inner sep=1.5pt] at (3.5, 0.5) {$X_L$};
    ...
    \begin{tikzpicture}[scale=0.6]
        ...
        \node[above, blue, fill=white, inner sep=1pt, rounded corners=2pt] at (2.4, 0.5) {$\mathbf{X_{L1}, Z_{L2}}$};
        \node[above, red, fill=white, inner sep=1pt, rounded corners=2pt] at (2.4, 1.86) {$\mathbf{X_{L3}, Z_{L4}}$};
        \node[right, red, fill=white, inner sep=1pt, rounded corners=2pt] at (0.5, 2.8) {$\mathbf{Z_{L3}, X_{L4}}$};
        \node[left, blue, fill=white, inner sep=1pt, rounded corners=2pt] at (-1.1, 2.8) {$\mathbf{Z_{L1}, X_{L2}}$};
    \end{tikzpicture}
    \caption{}
\end{subfigure}
...
\begin{subfigure}[b]{0.45\textwidth}
    ...
    \begin{tikzpicture}[scale=0.6]
        ...
        \node[right, red, fill=white, inner sep=1pt, rounded corners=2pt] at (0.5, 3.5) {$\mathbf{X_{L3}, Z_{L4}}$};
        \node[above, red!60!black, fill=white, inner sep=1pt, rounded corners=2pt] at (2.8, -0.4) {$\mathbf{Z_{L3}, X_{L4}}$};
        \node[right, blue, fill=white, inner sep=1pt, rounded corners=2pt] at (2.5, 2.5) {$\mathbf{X_{L1}, Z_{L2}}$};
        \node[left, green!60!black, fill=white, inner sep=1pt, rounded corners=2pt] at (-2.5, 2.5) {$\mathbf{Z_{L1}, X_{L2}}$};
    \end{tikzpicture}
    \caption{}
\end{subfigure}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[scale=0.55]
        ...
        % DRAWING THE DATA QUBITS ON TOP
...
\begin{notebox}{Pendiente}
Revisar esta sección, ampliarla un poco y explicar algo más. Entender bien como se construyencon los BBC con los polinomios
\end{notebox}
While 2D topological codes are very hardware-friendly, their reliance on local 2D planes strictly limits their scalability. To build future quantum supercomputers with millions of qubits, the overhead of surface and color codes might be too steep. This fact has drawn attention to non-topological QLDPC codes. By sacrificing strictly local 2D connectivity and embracing long-range physical connections, these QLDPC codes can maintain a constant encoding rate as they scale, that is, the ratio between logical qubits and physical qubits tends to a constant value.
...
Their physical implementation, however, is still an open engineering challenge. These codes require long-range couplers that are very difficult to realize (some proposals include optical interconnects or neutral atoms moving in optical tweezers). Therefore, the non topological QLDCP codes represent the ultimate frontier for next-generation fault-tolerant architectures.
