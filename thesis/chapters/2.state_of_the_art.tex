...
\begin{figure}[hbt!]
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        ...
        \input{figures/2.state_of_the_art/2:surface_code_evolution_a.tex}
        \caption{}
    \end{subfigure}
    \hfill
    ...
    \begin{subfigure}[b]{0.33\textwidth}
        \centering
        \input{figures/2.state_of_the_art/2:surface_code_evolution_b.tex}
        \caption{}
    \end{subfigure}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \input{figures/2.state_of_the_art/2:lattice_666_a.tex}
        \caption{}
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \input{figures/2.state_of_the_art/2:lattice_666_b.tex}
        \caption{}
    ...
    \begin{subfigure}[b]{0.3\textwidth}
        \centering
        \input{figures/2.state_of_the_art/2:lattice_666_c.tex}
        \caption{}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.345\textwidth}
        \centering
        \input{figures/2.state_of_the_art/2:color_code_logical_observables_a.tex}
        \caption{}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.335\textwidth}
        \centering
        \input{figures/2.state_of_the_art/2:color_code_logical_observables_b.tex}
        \caption{}
    \end{subfigure}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.47\textwidth}
        \centering
        \input{figures/2.state_of_the_art/2:planar_color_code_b.tex}
        \caption{}
    \end{subfigure}
