...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        \begin{tikzpicture}[scale=0.6]
            ...
            \node[right, red, fill=white, fill opacity=0.5,text opacity=1, inner sep=1pt, rounded corners=2pt] at (0.5, 3.5) {$\mathbf{X_{L3}, Z_{L4}}$};
            \node[below, red, fill=white, fill opacity=0.5,text opacity=1, inner sep=1pt, rounded corners=2pt] at (2.8, 0) {$\mathbf{Z_{L3}, X_{L4}}$};
            \node[right, blue, fill=white, fill opacity=0.5,text opacity=1, inner sep=1pt, rounded corners=2pt] at (2.5, 2.5) {$\mathbf{X_{L1}, Z_{L2}}$};
            \node[left, green!60!black, fill=white, fill opacity=0.5,text opacity=1, inner sep=1pt, rounded corners=2pt] at (-2.5, 2.5) {$\mathbf{Z_{L1}, X_{L2}}$};
        \end{tikzpicture}
        \caption{}
    \end{subfigure}
\end{figure}
